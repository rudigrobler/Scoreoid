...
namespace Scoreoid.UI
{
    public static class TextBoxHelpers
    {
        ...
        public static readonly DependencyProperty WatermarkProperty =
            DependencyProperty.RegisterAttached("Watermark", typeof(string), typeof(TextBoxHelpers), new PropertyMetadata(string.Empty, new PropertyChangedCallback(OnWatermarkChanged)));
                ...
                control.Loaded += (s, ev) =>
                    {
                        ...
                        if (grid != null)
                        {
                            var tb = new TextBlock() { Text = (string)e.NewValue, VerticalAlignment = VerticalAlignment.Center, Margin = new Thickness(10, -4, 0, 0) };
